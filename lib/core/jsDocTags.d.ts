...
export declare function zodPropertyIsOptional(): {
    identifier: string;
};
export declare function zodPropertyIsNullable(): {
    identifier: string;
};
export declare function zodPropertyIsPartial(): {
    identifier: string;
};
export declare function zodPropertyIsRequired(): {
    identifier: string;
};
/**
