...
exports.jsDocTagToZodProperties = exports.zodPropertyIsRequired = exports.zodPropertyIsPartial = exports.zodPropertyIsNullable = exports.zodPropertyIsOptional = exports.getJSDocTags = void 0;
...
function zodPropertyIsOptional() {
    return {
        identifier: "optional",
    };
}
exports.zodPropertyIsOptional = zodPropertyIsOptional;
function zodPropertyIsNullable() {
    return {
        identifier: "nullable",
    };
}
exports.zodPropertyIsNullable = zodPropertyIsNullable;
function zodPropertyIsPartial() {
    return {
        identifier: "partial",
    };
}
exports.zodPropertyIsPartial = zodPropertyIsPartial;
function zodPropertyIsRequired() {
    return {
        identifier: "required",
    };
}
exports.zodPropertyIsRequired = zodPropertyIsRequired;
/**
