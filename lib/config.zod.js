...
exports.tsToZodConfigSchema = exports.configsSchema = exports.configSchema = exports.jSDocTagFilterSchema = exports.nameFilterSchema = exports.getSchemaNameSchema = exports.simplifiedJSDocTagSchema = exports.maybe = void 0;
...
exports.configSchema = zod_1.z.object({
    ...
    maybeTypeNames: zod_1.z.array(zod_1.z.string()).optional(),
    maybeOptional: zod_1.z.boolean().optional().default(true),
    maybeNullable: zod_1.z.boolean().optional().default(true),
});
